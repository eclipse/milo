...
public class MultiStateDiscreteTypeNode extends DiscreteItemTypeNode implements MultiStateDiscreteType {
    public MultiStateDiscreteTypeNode(UaNodeContext context, NodeId nodeId, QualifiedName browseName,
    ...
    @Override
    public PropertyTypeNode getEnumStringsNode() {
    ...
    public LocalizedText[] getEnumStrings() {
        return getProperty(MultiStateDiscreteType.ENUM_STRINGS).orElse(null);
    }
