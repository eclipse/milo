...
public class FiniteStateVariableTypeNode extends StateVariableTypeNode implements FiniteStateVariableType {
    public FiniteStateVariableTypeNode(UaNodeContext context, NodeId nodeId, QualifiedName browseName,
    ...
    @Override
    public NodeId getId() {
        return getProperty(FiniteStateVariableType.ID).orElse(null);
    }
