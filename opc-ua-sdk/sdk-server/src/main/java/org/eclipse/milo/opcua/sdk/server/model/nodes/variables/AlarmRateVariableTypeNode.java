...
public class AlarmRateVariableTypeNode extends BaseDataVariableTypeNode implements AlarmRateVariableType {
    public AlarmRateVariableTypeNode(UaNodeContext context, NodeId nodeId, QualifiedName browseName,
    ...
    @Override
    public PropertyTypeNode getRateNode() {
        Optional<VariableNode> propertyNode = getPropertyNode(AlarmRateVariableType.RATE);
        return (PropertyTypeNode) propertyNode.orElse(null);
    }

    @Override
    public UShort getRate() {
        return getProperty(AlarmRateVariableType.RATE).orElse(null);
    }

    @Override
    public void setRate(UShort value) {
        setProperty(AlarmRateVariableType.RATE, value);
    }
}
