...
import org.eclipse.milo.opcua.sdk.server.model.types.objects.RoleSetType;
...
public class RoleSetTypeNode extends BaseObjectTypeNode implements RoleSetType {
    ...
    @Override
    public MethodNode getAddRoleMethodNode() {
    ...
    @Override
    public MethodNode getRemoveRoleMethodNode() {
