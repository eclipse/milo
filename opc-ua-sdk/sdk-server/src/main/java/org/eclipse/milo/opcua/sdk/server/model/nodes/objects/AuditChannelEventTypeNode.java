...
public class AuditChannelEventTypeNode extends AuditSecurityEventTypeNode implements AuditChannelEventType {
    public AuditChannelEventTypeNode(UaNodeContext context, NodeId nodeId, QualifiedName browseName,
    ...
    public String getSecureChannelId() {
        return getProperty(AuditChannelEventType.SECURE_CHANNEL_ID).orElse(null);
    }
