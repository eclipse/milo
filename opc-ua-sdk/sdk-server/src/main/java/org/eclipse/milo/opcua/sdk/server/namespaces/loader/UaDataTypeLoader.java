...
import org.eclipse.milo.opcua.sdk.server.model.UaDataTypeNode;
...
public class UaDataTypeLoader {
    ...
    private void buildNode0() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=1"), new QualifiedName(0, "Boolean"), new LocalizedText("en", "Boolean"), Optional.of(new LocalizedText("en", "Describes a value that is either TRUE or FALSE.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode1() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2"), new QualifiedName(0, "SByte"), new LocalizedText("en", "SByte"), Optional.of(new LocalizedText("en", "Describes a value that is an integer between -128 and 127.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode2() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=3"), new QualifiedName(0, "Byte"), new LocalizedText("en", "Byte"), Optional.of(new LocalizedText("en", "Describes a value that is an integer between 0 and 255.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode3() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=4"), new QualifiedName(0, "Int16"), new LocalizedText("en", "Int16"), Optional.of(new LocalizedText("en", "Describes a value that is an integer between \u221232,768 and 32,767.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode4() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=5"), new QualifiedName(0, "UInt16"), new LocalizedText("en", "UInt16"), Optional.of(new LocalizedText("en", "Describes a value that is an integer between 0 and 65535.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode6() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=7"), new QualifiedName(0, "UInt32"), new LocalizedText("en", "UInt32"), Optional.of(new LocalizedText("en", "Describes a value that is an integer between 0 and 4,294,967,295.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode11() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12"), new QualifiedName(0, "String"), new LocalizedText("en", "String"), Optional.of(new LocalizedText("en", "Describes a value that is a sequence of printable Unicode characters.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode12() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=13"), new QualifiedName(0, "DateTime"), new LocalizedText("en", "DateTime"), Optional.of(new LocalizedText("en", "Describes a value that is a Gregorian calender date and time.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode13() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=14"), new QualifiedName(0, "Guid"), new LocalizedText("en", "Guid"), Optional.of(new LocalizedText("en", "Describes a value that is a 128-bit globally unique identifier.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode14() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=15"), new QualifiedName(0, "ByteString"), new LocalizedText("en", "ByteString"), Optional.of(new LocalizedText("en", "Describes a value that is a sequence of bytes.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode15() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=16"), new QualifiedName(0, "XmlElement"), new LocalizedText("en", "XmlElement"), Optional.of(new LocalizedText("en", "Describes a value that is an XML element.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode23() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=24"), new QualifiedName(0, "BaseDataType"), new LocalizedText("en", "BaseDataType"), Optional.of(new LocalizedText("en", "Describes a value that can have any valid DataType.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode25() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=26"), new QualifiedName(0, "Number"), new LocalizedText("en", "Number"), Optional.of(new LocalizedText("en", "Describes a value that can have any numeric DataType.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode26() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=27"), new QualifiedName(0, "Integer"), new LocalizedText("en", "Integer"), Optional.of(new LocalizedText("en", "Describes a value that can have any integer DataType.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode27() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=28"), new QualifiedName(0, "UInteger"), new LocalizedText("en", "UInteger"), Optional.of(new LocalizedText("en", "Describes a value that can have any unsigned integer DataType.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode28() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=29"), new QualifiedName(0, "Enumeration"), new LocalizedText("en", "Enumeration"), Optional.of(new LocalizedText("en", "Describes a value that is an enumerated DataType.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode29() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=30"), new QualifiedName(0, "Image"), new LocalizedText("en", "Image"), Optional.of(new LocalizedText("en", "Describes a value that is an image encoded as a string of bytes.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode31() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=121"), new QualifiedName(0, "Decimal128"), new LocalizedText("en", "Decimal128"), Optional.of(new LocalizedText("en", "Describes a 128-bit decimal value.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode32() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12504"), new QualifiedName(0, "KerberosIdentityToken"), new LocalizedText("en", "KerberosIdentityToken"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode33() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=256"), new QualifiedName(0, "IdType"), new LocalizedText("en", "IdType"), Optional.of(new LocalizedText("en", "The type of identifier used in a node id.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode34() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=257"), new QualifiedName(0, "NodeClass"), new LocalizedText("en", "NodeClass"), Optional.of(new LocalizedText("en", "A mask specifying the class of the node.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode35() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12552"), new QualifiedName(0, "TrustListMasks"), new LocalizedText("en", "TrustListMasks"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode36() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12554"), new QualifiedName(0, "TrustListDataType"), new LocalizedText("en", "TrustListDataType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode37() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=288"), new QualifiedName(0, "IntegerId"), new LocalizedText("en", "IntegerId"), Optional.of(new LocalizedText("en", "A numeric identifier for an object.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode38() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=289"), new QualifiedName(0, "Counter"), new LocalizedText("en", "Counter"), Optional.of(new LocalizedText("en", "A monotonically increasing value.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode39() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=290"), new QualifiedName(0, "Duration"), new LocalizedText("en", "Duration"), Optional.of(new LocalizedText("en", "A period of time measured in milliseconds.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode40() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=291"), new QualifiedName(0, "NumericRange"), new LocalizedText("en", "NumericRange"), Optional.of(new LocalizedText("en", "Specifies a range of array indexes.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode41() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=292"), new QualifiedName(0, "Time"), new LocalizedText("en", "Time"), Optional.of(new LocalizedText("en", "A time value specified as HH:MM:SS.SSS.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode42() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=293"), new QualifiedName(0, "Date"), new LocalizedText("en", "Date"), Optional.of(new LocalizedText("en", "A date value.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode43() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=294"), new QualifiedName(0, "UtcTime"), new LocalizedText("en", "UtcTime"), Optional.of(new LocalizedText("en", "A date/time value specified in Universal Coordinated Time (UTC).")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode44() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=295"), new QualifiedName(0, "LocaleId"), new LocalizedText("en", "LocaleId"), Optional.of(new LocalizedText("en", "An identifier for a user locale.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode45() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=296"), new QualifiedName(0, "Argument"), new LocalizedText("en", "Argument"), Optional.of(new LocalizedText("en", "An argument for a method.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode46() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=299"), new QualifiedName(0, "StatusResult"), new LocalizedText("en", "StatusResult"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode47() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=302"), new QualifiedName(0, "MessageSecurityMode"), new LocalizedText("en", "MessageSecurityMode"), Optional.of(new LocalizedText("en", "The type of security to use on a message.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode48() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=303"), new QualifiedName(0, "UserTokenType"), new LocalizedText("en", "UserTokenType"), Optional.of(new LocalizedText("en", "The possible user token types.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode50() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=307"), new QualifiedName(0, "ApplicationType"), new LocalizedText("en", "ApplicationType"), Optional.of(new LocalizedText("en", "The types of applications.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode55() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=316"), new QualifiedName(0, "UserIdentityToken"), new LocalizedText("en", "UserIdentityToken"), Optional.of(new LocalizedText("en", "A base type for a user identity token.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode58() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=325"), new QualifiedName(0, "X509IdentityToken"), new LocalizedText("en", "X509IdentityToken"), Optional.of(new LocalizedText("en", "A token representing a user identified by an X509 certificate.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode59() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=331"), new QualifiedName(0, "EndpointConfiguration"), new LocalizedText("en", "EndpointConfiguration"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode60() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=334"), new QualifiedName(0, "ComplianceLevel"), new LocalizedText("en", "ComplianceLevel"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode61() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=335"), new QualifiedName(0, "SupportedProfile"), new LocalizedText("en", "SupportedProfile"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode62() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=338"), new QualifiedName(0, "BuildInfo"), new LocalizedText("en", "BuildInfo"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode63() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=341"), new QualifiedName(0, "SoftwareCertificate"), new LocalizedText("en", "SoftwareCertificate"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode65() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=347"), new QualifiedName(0, "AttributeWriteMask"), new LocalizedText("en", "AttributeWriteMask"), Optional.of(new LocalizedText("en", "Define bits used to indicate which attributes are writable.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode67() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=376"), new QualifiedName(0, "AddNodesItem"), new LocalizedText("en", "AddNodesItem"), Optional.of(new LocalizedText("en", "A request to add a node to the server address space.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode68() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=379"), new QualifiedName(0, "AddReferencesItem"), new LocalizedText("en", "AddReferencesItem"), Optional.of(new LocalizedText("en", "A request to add a reference to the server address space.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode69() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=382"), new QualifiedName(0, "DeleteNodesItem"), new LocalizedText("en", "DeleteNodesItem"), Optional.of(new LocalizedText("en", "A request to delete a node to the server address space.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode70() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=385"), new QualifiedName(0, "DeleteReferencesItem"), new LocalizedText("en", "DeleteReferencesItem"), Optional.of(new LocalizedText("en", "A request to delete a node from the server address space.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode72() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=398"), new QualifiedName(0, "EnumeratedTestType"), new LocalizedText("en", "EnumeratedTestType"), Optional.of(new LocalizedText("en", "A simple enumerated type used for testing.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode74() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12755"), new QualifiedName(0, "OptionSet"), new LocalizedText("en", "OptionSet"), Optional.of(new LocalizedText("en", "This abstract Structured DataType is the base DataType for all DataTypes representing a bit mask.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode75() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12756"), new QualifiedName(0, "Union"), new LocalizedText("en", "Union"), Optional.of(new LocalizedText("en", "This abstract DataType is the base DataType for all union DataTypes.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode77() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=537"), new QualifiedName(0, "RelativePathElement"), new LocalizedText("en", "RelativePathElement"), Optional.of(new LocalizedText("en", "An element in a relative path.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode78() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=540"), new QualifiedName(0, "RelativePath"), new LocalizedText("en", "RelativePath"), Optional.of(new LocalizedText("en", "A relative path constructed from reference types and browse names.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode79() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=576"), new QualifiedName(0, "FilterOperator"), new LocalizedText("en", "FilterOperator"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode80() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=583"), new QualifiedName(0, "ContentFilterElement"), new LocalizedText("en", "ContentFilterElement"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode81() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=586"), new QualifiedName(0, "ContentFilter"), new LocalizedText("en", "ContentFilter"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode82() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12877"), new QualifiedName(0, "NormalizedString"), new LocalizedText("en", "NormalizedString"), Optional.of(new LocalizedText("en", "A string normalized based on the rules in the unicode specification.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode83() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=589"), new QualifiedName(0, "FilterOperand"), new LocalizedText("en", "FilterOperand"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode84() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12878"), new QualifiedName(0, "DecimalString"), new LocalizedText("en", "DecimalString"), Optional.of(new LocalizedText("en", "An arbitraty numeric value.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode85() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12879"), new QualifiedName(0, "DurationString"), new LocalizedText("en", "DurationString"), Optional.of(new LocalizedText("en", "A period of time formatted as defined in ISO 8601-2000.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode86() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12880"), new QualifiedName(0, "TimeString"), new LocalizedText("en", "TimeString"), Optional.of(new LocalizedText("en", "A time formatted as defined in ISO 8601-2000.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode87() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=592"), new QualifiedName(0, "ElementOperand"), new LocalizedText("en", "ElementOperand"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode88() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12881"), new QualifiedName(0, "DateString"), new LocalizedText("en", "DateString"), Optional.of(new LocalizedText("en", "A date formatted as defined in ISO 8601-2000.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode89() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=595"), new QualifiedName(0, "LiteralOperand"), new LocalizedText("en", "LiteralOperand"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode90() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=598"), new QualifiedName(0, "AttributeOperand"), new LocalizedText("en", "AttributeOperand"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode91() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=601"), new QualifiedName(0, "SimpleAttributeOperand"), new LocalizedText("en", "SimpleAttributeOperand"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode92() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12890"), new QualifiedName(0, "DiscoveryConfiguration"), new LocalizedText("en", "DiscoveryConfiguration"), Optional.of(new LocalizedText("en", "A base type for discovery configuration information.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode93() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12891"), new QualifiedName(0, "MdnsDiscoveryConfiguration"), new LocalizedText("en", "MdnsDiscoveryConfiguration"), Optional.of(new LocalizedText("en", "The discovery information needed for mDNS registration.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode94() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=659"), new QualifiedName(0, "HistoryEvent"), new LocalizedText("en", "HistoryEvent"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode95() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=719"), new QualifiedName(0, "MonitoringFilter"), new LocalizedText("en", "MonitoringFilter"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode96() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=8912"), new QualifiedName(0, "TimeZoneDataType"), new LocalizedText("en", "TimeZoneDataType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode97() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=725"), new QualifiedName(0, "EventFilter"), new LocalizedText("en", "EventFilter"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode98() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=851"), new QualifiedName(0, "RedundancySupport"), new LocalizedText("en", "RedundancySupport"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode99() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=852"), new QualifiedName(0, "ServerState"), new LocalizedText("en", "ServerState"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode100() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=853"), new QualifiedName(0, "RedundantServerDataType"), new LocalizedText("en", "RedundantServerDataType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode101() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=856"), new QualifiedName(0, "SamplingIntervalDiagnosticsDataType"), new LocalizedText("en", "SamplingIntervalDiagnosticsDataType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode102() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=859"), new QualifiedName(0, "ServerDiagnosticsSummaryDataType"), new LocalizedText("en", "ServerDiagnosticsSummaryDataType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode103() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=862"), new QualifiedName(0, "ServerStatusDataType"), new LocalizedText("en", "ServerStatusDataType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode104() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=865"), new QualifiedName(0, "SessionDiagnosticsDataType"), new LocalizedText("en", "SessionDiagnosticsDataType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode105() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=868"), new QualifiedName(0, "SessionSecurityDiagnosticsDataType"), new LocalizedText("en", "SessionSecurityDiagnosticsDataType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode106() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=871"), new QualifiedName(0, "ServiceCounterDataType"), new LocalizedText("en", "ServiceCounterDataType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode107() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=874"), new QualifiedName(0, "SubscriptionDiagnosticsDataType"), new LocalizedText("en", "SubscriptionDiagnosticsDataType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode108() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=877"), new QualifiedName(0, "ModelChangeStructureDataType"), new LocalizedText("en", "ModelChangeStructureDataType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode109() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=884"), new QualifiedName(0, "Range"), new LocalizedText("en", "Range"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode110() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=887"), new QualifiedName(0, "EUInformation"), new LocalizedText("en", "EUInformation"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode111() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=890"), new QualifiedName(0, "ExceptionDeviationFormat"), new LocalizedText("en", "ExceptionDeviationFormat"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode112() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=891"), new QualifiedName(0, "Annotation"), new LocalizedText("en", "Annotation"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode113() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=894"), new QualifiedName(0, "ProgramDiagnosticDataType"), new LocalizedText("en", "ProgramDiagnosticDataType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode114() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=897"), new QualifiedName(0, "SemanticChangeStructureDataType"), new LocalizedText("en", "SemanticChangeStructureDataType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode115() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=920"), new QualifiedName(0, "HistoryEventFieldList"), new LocalizedText("en", "HistoryEventFieldList"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode117() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=948"), new QualifiedName(0, "AggregateConfiguration"), new LocalizedText("en", "AggregateConfiguration"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode118() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2000"), new QualifiedName(0, "ImageBMP"), new LocalizedText("en", "ImageBMP"), Optional.of(new LocalizedText("en", "An image encoded in BMP format.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode119() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2001"), new QualifiedName(0, "ImageGIF"), new LocalizedText("en", "ImageGIF"), Optional.of(new LocalizedText("en", "An image encoded in GIF format.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode120() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2002"), new QualifiedName(0, "ImageJPG"), new LocalizedText("en", "ImageJPG"), Optional.of(new LocalizedText("en", "An image encoded in JPEG format.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode121() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2003"), new QualifiedName(0, "ImagePNG"), new LocalizedText("en", "ImagePNG"), Optional.of(new LocalizedText("en", "An image encoded in PNG format.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode122() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=11234"), new QualifiedName(0, "HistoryUpdateType"), new LocalizedText("en", "HistoryUpdateType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode123() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=11293"), new QualifiedName(0, "PerformUpdateType"), new LocalizedText("en", "PerformUpdateType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode124() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=7594"), new QualifiedName(0, "EnumValueType"), new LocalizedText("en", "EnumValueType"), Optional.of(new LocalizedText("en", "A mapping between a value of an enumerated type and a name and description.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode126() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=11939"), new QualifiedName(0, "OpenFileMode"), new LocalizedText("en", "OpenFileMode"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode127() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=11943"), new QualifiedName(0, "EndpointUrlListDataType"), new LocalizedText("en", "EndpointUrlListDataType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode128() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=11944"), new QualifiedName(0, "NetworkGroupDataType"), new LocalizedText("en", "NetworkGroupDataType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode129() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12077"), new QualifiedName(0, "AxisScaleEnumeration"), new LocalizedText("en", "AxisScaleEnumeration"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode130() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12079"), new QualifiedName(0, "AxisInformation"), new LocalizedText("en", "AxisInformation"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode131() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12080"), new QualifiedName(0, "XVType"), new LocalizedText("en", "XVType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode132() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12171"), new QualifiedName(0, "ComplexNumberType"), new LocalizedText("en", "ComplexNumberType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode133() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12172"), new QualifiedName(0, "DoubleComplexNumberType"), new LocalizedText("en", "DoubleComplexNumberType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode134() {
        UaDataTypeNode node = new UaDataTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12189"), new QualifiedName(0, "ServerOnNetwork"), new LocalizedText("en", "ServerOnNetwork"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
