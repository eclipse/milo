...
public class ReferenceDescriptionVariableTypeNode extends BaseDataVariableTypeNode implements ReferenceDescriptionVariableType {
    public ReferenceDescriptionVariableTypeNode(UaNodeContext context, NodeId nodeId,
    ...
    @Override
    public PropertyTypeNode getReferenceRefinementNode() {
        Optional<VariableNode> propertyNode = getPropertyNode(ReferenceDescriptionVariableType.REFERENCE_REFINEMENT);
        return (PropertyTypeNode) propertyNode.orElse(null);
    }

    @Override
    public ReferenceListEntryDataType[] getReferenceRefinement() {
        return getProperty(ReferenceDescriptionVariableType.REFERENCE_REFINEMENT).orElse(null);
    }

    @Override
    public void setReferenceRefinement(ReferenceListEntryDataType[] value) {
        setProperty(ReferenceDescriptionVariableType.REFERENCE_REFINEMENT, value);
    }
}
