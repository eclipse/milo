...
public class AuditConditionAcknowledgeEventTypeNode extends AuditConditionEventTypeNode implements AuditConditionAcknowledgeEventType {
    ...
    public PropertyTypeNode getConditionEventIdNode() {
        Optional<VariableNode> propertyNode = getPropertyNode(AuditConditionAcknowledgeEventType.CONDITION_EVENT_ID);
        return (PropertyTypeNode) propertyNode.orElse(null);
    }

    @Override
    public ByteString getConditionEventId() {
        return getProperty(AuditConditionAcknowledgeEventType.CONDITION_EVENT_ID).orElse(null);
    }

    @Override
    public void setConditionEventId(ByteString value) {
        setProperty(AuditConditionAcknowledgeEventType.CONDITION_EVENT_ID, value);
    }
    ...
    public LocalizedText getComment() {
        return getProperty(AuditConditionAcknowledgeEventType.COMMENT).orElse(null);
    }
