...
import org.eclipse.milo.opcua.sdk.server.model.types.objects.PubSubKeyPushTargetFolderType;
...
public class PubSubKeyPushTargetFolderTypeNode extends FolderTypeNode implements PubSubKeyPushTargetFolderType {
    ...
    @Override
    public MethodNode getAddPushTargetMethodNode() {
    ...
    @Override
    public MethodNode getRemovePushTargetMethodNode() {
    ...
    @Override
    public MethodNode getAddPushTargetFolderMethodNode() {
    ...
    @Override
    public MethodNode getRemovePushTargetFolderMethodNode() {
