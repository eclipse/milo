...
import org.eclipse.milo.opcua.sdk.server.model.UaReferenceTypeNode;
...
public class UaReferenceTypeLoader {
    ...
    private void buildNode23() {
        UaReferenceTypeNode node = new UaReferenceTypeNode(this.nodeManager, NodeId.parse("ns=0;i=9004"), new QualifiedName(0, "HasTrueSubState"), new LocalizedText("en", "HasTrueSubState"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false, false, Optional.of(new LocalizedText("en", "IsTrueSubStateOf")));
    ...
    private void buildNode24() {
        UaReferenceTypeNode node = new UaReferenceTypeNode(this.nodeManager, NodeId.parse("ns=0;i=9005"), new QualifiedName(0, "HasFalseSubState"), new LocalizedText("en", "HasFalseSubState"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false, false, Optional.of(new LocalizedText("en", "IsFalseSubStateOf")));
    ...
    private void buildNode25() {
        UaReferenceTypeNode node = new UaReferenceTypeNode(this.nodeManager, NodeId.parse("ns=0;i=9006"), new QualifiedName(0, "HasCondition"), new LocalizedText("en", "HasCondition"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false, false, Optional.of(new LocalizedText("en", "IsConditionOf")));
