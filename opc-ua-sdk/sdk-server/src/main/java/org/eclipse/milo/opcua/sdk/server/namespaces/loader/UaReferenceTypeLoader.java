...
public class UaReferenceTypeLoader {
    ...
    public UaReferenceTypeLoader(OpcUaServer server) {
        this.server = server;
    }

    private void buildNode0() {
        UaReferenceTypeNode node = new UaReferenceTypeNode(this.server, NodeId.parse("ns=0;i=31"), new QualifiedName(0, "References"), new LocalizedText("en", "References"), new LocalizedText("en", "The abstract base type for all references."), UInteger.valueOf(0L), UInteger.valueOf(0L), true, true, new LocalizedText("en", "References"));
    ...
    private void buildNode7() {
        UaReferenceTypeNode node = new UaReferenceTypeNode(this.server, NodeId.parse("ns=0;i=38"), new QualifiedName(0, "HasEncoding"), new LocalizedText("en", "HasEncoding"), new LocalizedText("en", "The type for references from data type nodes to to data type encoding nodes."), UInteger.valueOf(0L), UInteger.valueOf(0L), false, false, new LocalizedText("en", "EncodingOf"));
    ...
    private void buildNode14() {
        UaReferenceTypeNode node = new UaReferenceTypeNode(this.server, NodeId.parse("ns=0;i=47"), new QualifiedName(0, "HasComponent"), new LocalizedText("en", "HasComponent"), new LocalizedText("en", "The type for non-looping hierarchical reference from a node to its component."), UInteger.valueOf(0L), UInteger.valueOf(0L), false, false, new LocalizedText("en", "ComponentOf"));
    ...
    private void buildNode23() {
        UaReferenceTypeNode node = new UaReferenceTypeNode(this.server, NodeId.parse("ns=0;i=9004"), new QualifiedName(0, "HasTrueSubState"), new LocalizedText("en", "HasTrueSubState"), LocalizedText.NULL_VALUE, UInteger.valueOf(0L), UInteger.valueOf(0L), false, false, new LocalizedText("en", "IsTrueSubStateOf"));
    ...
    private void buildNode24() {
        UaReferenceTypeNode node = new UaReferenceTypeNode(this.server, NodeId.parse("ns=0;i=9005"), new QualifiedName(0, "HasFalseSubState"), new LocalizedText("en", "HasFalseSubState"), LocalizedText.NULL_VALUE, UInteger.valueOf(0L), UInteger.valueOf(0L), false, false, new LocalizedText("en", "IsFalseSubStateOf"));
    ...
    private void buildNode25() {
        UaReferenceTypeNode node = new UaReferenceTypeNode(this.server, NodeId.parse("ns=0;i=9006"), new QualifiedName(0, "HasCondition"), new LocalizedText("en", "HasCondition"), LocalizedText.NULL_VALUE, UInteger.valueOf(0L), UInteger.valueOf(0L), false, false, new LocalizedText("en", "IsConditionOf"));
