...
public class AuditConditionRespondEventTypeNode extends AuditConditionEventTypeNode implements AuditConditionRespondEventType {
    ...
    @Override
    public UInteger getSelectedResponse() {
        return getProperty(AuditConditionRespondEventType.SELECTED_RESPONSE).orElse(null);
    }

    @Override
    public void setSelectedResponse(UInteger value) {
