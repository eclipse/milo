...
public class UaObjectTypeLoader {
    ...
    public UaObjectTypeLoader(UaNodeManager nodeManager) {
        this.nodeManager = nodeManager;
    }

    private void buildNode0() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=58"), new QualifiedName(0, "BaseObjectType"), new LocalizedText("en", "BaseObjectType"), Optional.of(new LocalizedText("en", "The base type for all object nodes.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode1() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=61"), new QualifiedName(0, "FolderType"), new LocalizedText("en", "FolderType"), Optional.of(new LocalizedText("en", "The type for objects that organize other nodes.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode2() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=75"), new QualifiedName(0, "DataTypeSystemType"), new LocalizedText("en", "DataTypeSystemType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode3() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=76"), new QualifiedName(0, "DataTypeEncodingType"), new LocalizedText("en", "DataTypeEncodingType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode4() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=77"), new QualifiedName(0, "ModellingRuleType"), new LocalizedText("en", "ModellingRuleType"), Optional.of(new LocalizedText("en", "The type for an object that describes how an instance declaration is used when a type is instantiated.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode5() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12522"), new QualifiedName(0, "TrustListType"), new LocalizedText("en", "TrustListType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode6() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12555"), new QualifiedName(0, "CertificateGroupType"), new LocalizedText("en", "CertificateGroupType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode7() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12556"), new QualifiedName(0, "CertificateType"), new LocalizedText("en", "CertificateType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode8() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12557"), new QualifiedName(0, "ApplicationCertificateType"), new LocalizedText("en", "ApplicationCertificateType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode9() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12558"), new QualifiedName(0, "HttpsCertificateType"), new LocalizedText("en", "HttpsCertificateType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode10() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12559"), new QualifiedName(0, "RsaMinApplicationCertificateType"), new LocalizedText("en", "RsaMinApplicationCertificateType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode11() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12560"), new QualifiedName(0, "RsaSha256ApplicationCertificateType"), new LocalizedText("en", "RsaSha256ApplicationCertificateType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode12() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12561"), new QualifiedName(0, "TrustListUpdatedAuditEventType"), new LocalizedText("en", "TrustListUpdatedAuditEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode13() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12581"), new QualifiedName(0, "ServerConfigurationType"), new LocalizedText("en", "ServerConfigurationType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode14() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=12620"), new QualifiedName(0, "CertificateUpdatedAuditEventType"), new LocalizedText("en", "CertificateUpdatedAuditEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode15() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=8927"), new QualifiedName(0, "AuditConditionRespondEventType"), new LocalizedText("en", "AuditConditionRespondEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode16() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=8944"), new QualifiedName(0, "AuditConditionAcknowledgeEventType"), new LocalizedText("en", "AuditConditionAcknowledgeEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode17() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=8961"), new QualifiedName(0, "AuditConditionConfirmEventType"), new LocalizedText("en", "AuditConditionConfirmEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode18() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=13225"), new QualifiedName(0, "CertificateExpirationAlarmType"), new LocalizedText("en", "CertificateExpirationAlarmType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode19() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=13353"), new QualifiedName(0, "FileDirectoryType"), new LocalizedText("en", "FileDirectoryType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode20() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=9318"), new QualifiedName(0, "ExclusiveLimitStateMachineType"), new LocalizedText("en", "ExclusiveLimitStateMachineType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode21() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=9341"), new QualifiedName(0, "ExclusiveLimitAlarmType"), new LocalizedText("en", "ExclusiveLimitAlarmType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode22() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=9482"), new QualifiedName(0, "ExclusiveLevelAlarmType"), new LocalizedText("en", "ExclusiveLevelAlarmType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode23() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=9623"), new QualifiedName(0, "ExclusiveRateOfChangeAlarmType"), new LocalizedText("en", "ExclusiveRateOfChangeAlarmType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode24() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=13813"), new QualifiedName(0, "CertificateGroupFolderType"), new LocalizedText("en", "CertificateGroupFolderType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode25() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=9764"), new QualifiedName(0, "ExclusiveDeviationAlarmType"), new LocalizedText("en", "ExclusiveDeviationAlarmType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode26() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=9906"), new QualifiedName(0, "NonExclusiveLimitAlarmType"), new LocalizedText("en", "NonExclusiveLimitAlarmType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode27() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=10060"), new QualifiedName(0, "NonExclusiveLevelAlarmType"), new LocalizedText("en", "NonExclusiveLevelAlarmType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode28() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2004"), new QualifiedName(0, "ServerType"), new LocalizedText("en", "ServerType"), Optional.of(new LocalizedText("en", "Specifies the current status and capabilities of the server.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode29() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2013"), new QualifiedName(0, "ServerCapabilitiesType"), new LocalizedText("en", "ServerCapabilitiesType"), Optional.of(new LocalizedText("en", "Describes the capabilities supported by the server.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode30() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2020"), new QualifiedName(0, "ServerDiagnosticsType"), new LocalizedText("en", "ServerDiagnosticsType"), Optional.of(new LocalizedText("en", "The diagnostics information for a server.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode31() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=10214"), new QualifiedName(0, "NonExclusiveRateOfChangeAlarmType"), new LocalizedText("en", "NonExclusiveRateOfChangeAlarmType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode32() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2026"), new QualifiedName(0, "SessionsDiagnosticsSummaryType"), new LocalizedText("en", "SessionsDiagnosticsSummaryType"), Optional.of(new LocalizedText("en", "Provides a summary of session level diagnostics.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode33() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2029"), new QualifiedName(0, "SessionDiagnosticsObjectType"), new LocalizedText("en", "SessionDiagnosticsObjectType"), Optional.of(new LocalizedText("en", "A container for session level diagnostics information.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode34() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2033"), new QualifiedName(0, "VendorServerInfoType"), new LocalizedText("en", "VendorServerInfoType"), Optional.of(new LocalizedText("en", "A base type for vendor specific server information.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode35() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2034"), new QualifiedName(0, "ServerRedundancyType"), new LocalizedText("en", "ServerRedundancyType"), Optional.of(new LocalizedText("en", "A base type for an object that describe how a server supports redundancy.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode36() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2036"), new QualifiedName(0, "TransparentRedundancyType"), new LocalizedText("en", "TransparentRedundancyType"), Optional.of(new LocalizedText("en", "Identifies the capabilties of server that supports transparent redundancy.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode37() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2039"), new QualifiedName(0, "NonTransparentRedundancyType"), new LocalizedText("en", "NonTransparentRedundancyType"), Optional.of(new LocalizedText("en", "Identifies the capabilties of server that supports non-transparent redundancy.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode38() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2041"), new QualifiedName(0, "BaseEventType"), new LocalizedText("en", "BaseEventType"), Optional.of(new LocalizedText("en", "The base type for all events.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode39() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2052"), new QualifiedName(0, "AuditEventType"), new LocalizedText("en", "AuditEventType"), Optional.of(new LocalizedText("en", "A base type for events used to track client initiated changes to the server state.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode40() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2058"), new QualifiedName(0, "AuditSecurityEventType"), new LocalizedText("en", "AuditSecurityEventType"), Optional.of(new LocalizedText("en", "A base type for events used to track security related changes.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode41() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2059"), new QualifiedName(0, "AuditChannelEventType"), new LocalizedText("en", "AuditChannelEventType"), Optional.of(new LocalizedText("en", "A base type for events used to track related changes to a secure channel.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode42() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2060"), new QualifiedName(0, "AuditOpenSecureChannelEventType"), new LocalizedText("en", "AuditOpenSecureChannelEventType"), Optional.of(new LocalizedText("en", "An event that is raised when a secure channel is opened.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode43() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2069"), new QualifiedName(0, "AuditSessionEventType"), new LocalizedText("en", "AuditSessionEventType"), Optional.of(new LocalizedText("en", "A base type for events used to track related changes to a session.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode44() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2071"), new QualifiedName(0, "AuditCreateSessionEventType"), new LocalizedText("en", "AuditCreateSessionEventType"), Optional.of(new LocalizedText("en", "An event that is raised when a session is created.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode45() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2075"), new QualifiedName(0, "AuditActivateSessionEventType"), new LocalizedText("en", "AuditActivateSessionEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode46() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2078"), new QualifiedName(0, "AuditCancelEventType"), new LocalizedText("en", "AuditCancelEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode47() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2080"), new QualifiedName(0, "AuditCertificateEventType"), new LocalizedText("en", "AuditCertificateEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode48() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2082"), new QualifiedName(0, "AuditCertificateDataMismatchEventType"), new LocalizedText("en", "AuditCertificateDataMismatchEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode49() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2085"), new QualifiedName(0, "AuditCertificateExpiredEventType"), new LocalizedText("en", "AuditCertificateExpiredEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode50() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2086"), new QualifiedName(0, "AuditCertificateInvalidEventType"), new LocalizedText("en", "AuditCertificateInvalidEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode51() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2087"), new QualifiedName(0, "AuditCertificateUntrustedEventType"), new LocalizedText("en", "AuditCertificateUntrustedEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode52() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2088"), new QualifiedName(0, "AuditCertificateRevokedEventType"), new LocalizedText("en", "AuditCertificateRevokedEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode53() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2089"), new QualifiedName(0, "AuditCertificateMismatchEventType"), new LocalizedText("en", "AuditCertificateMismatchEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode54() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2090"), new QualifiedName(0, "AuditNodeManagementEventType"), new LocalizedText("en", "AuditNodeManagementEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode55() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2091"), new QualifiedName(0, "AuditAddNodesEventType"), new LocalizedText("en", "AuditAddNodesEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode56() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2093"), new QualifiedName(0, "AuditDeleteNodesEventType"), new LocalizedText("en", "AuditDeleteNodesEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode57() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2095"), new QualifiedName(0, "AuditAddReferencesEventType"), new LocalizedText("en", "AuditAddReferencesEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode58() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2097"), new QualifiedName(0, "AuditDeleteReferencesEventType"), new LocalizedText("en", "AuditDeleteReferencesEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode59() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2099"), new QualifiedName(0, "AuditUpdateEventType"), new LocalizedText("en", "AuditUpdateEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode60() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2100"), new QualifiedName(0, "AuditWriteUpdateEventType"), new LocalizedText("en", "AuditWriteUpdateEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode61() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2104"), new QualifiedName(0, "AuditHistoryUpdateEventType"), new LocalizedText("en", "AuditHistoryUpdateEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode62() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2127"), new QualifiedName(0, "AuditUpdateMethodEventType"), new LocalizedText("en", "AuditUpdateMethodEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode63() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2130"), new QualifiedName(0, "SystemEventType"), new LocalizedText("en", "SystemEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode64() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2131"), new QualifiedName(0, "DeviceFailureEventType"), new LocalizedText("en", "DeviceFailureEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode65() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2132"), new QualifiedName(0, "BaseModelChangeEventType"), new LocalizedText("en", "BaseModelChangeEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode66() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2133"), new QualifiedName(0, "GeneralModelChangeEventType"), new LocalizedText("en", "GeneralModelChangeEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode67() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=10368"), new QualifiedName(0, "NonExclusiveDeviationAlarmType"), new LocalizedText("en", "NonExclusiveDeviationAlarmType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode68() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2299"), new QualifiedName(0, "StateMachineType"), new LocalizedText("en", "StateMachineType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode69() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2307"), new QualifiedName(0, "StateType"), new LocalizedText("en", "StateType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode70() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2309"), new QualifiedName(0, "InitialStateType"), new LocalizedText("en", "InitialStateType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode71() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2310"), new QualifiedName(0, "TransitionType"), new LocalizedText("en", "TransitionType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode72() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2311"), new QualifiedName(0, "TransitionEventType"), new LocalizedText("en", "TransitionEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode73() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2315"), new QualifiedName(0, "AuditUpdateStateEventType"), new LocalizedText("en", "AuditUpdateStateEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode74() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2318"), new QualifiedName(0, "HistoricalDataConfigurationType"), new LocalizedText("en", "HistoricalDataConfigurationType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode75() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2330"), new QualifiedName(0, "HistoryServerCapabilitiesType"), new LocalizedText("en", "HistoryServerCapabilitiesType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode76() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=10523"), new QualifiedName(0, "DiscreteAlarmType"), new LocalizedText("en", "DiscreteAlarmType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode77() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2340"), new QualifiedName(0, "AggregateFunctionType"), new LocalizedText("en", "AggregateFunctionType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode78() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2378"), new QualifiedName(0, "ProgramTransitionEventType"), new LocalizedText("en", "ProgramTransitionEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode79() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2391"), new QualifiedName(0, "ProgramStateMachineType"), new LocalizedText("en", "ProgramStateMachineType"), Optional.of(new LocalizedText("en", "A state machine for a program.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode80() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=10637"), new QualifiedName(0, "OffNormalAlarmType"), new LocalizedText("en", "OffNormalAlarmType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode81() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=10751"), new QualifiedName(0, "TripAlarmType"), new LocalizedText("en", "TripAlarmType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode82() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2738"), new QualifiedName(0, "SemanticChangeEventType"), new LocalizedText("en", "SemanticChangeEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode83() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2748"), new QualifiedName(0, "AuditUrlMismatchEventType"), new LocalizedText("en", "AuditUrlMismatchEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode84() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2771"), new QualifiedName(0, "FiniteStateMachineType"), new LocalizedText("en", "FiniteStateMachineType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode85() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2782"), new QualifiedName(0, "ConditionType"), new LocalizedText("en", "ConditionType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode86() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2787"), new QualifiedName(0, "RefreshStartEventType"), new LocalizedText("en", "RefreshStartEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode87() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2788"), new QualifiedName(0, "RefreshEndEventType"), new LocalizedText("en", "RefreshEndEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode88() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2789"), new QualifiedName(0, "RefreshRequiredEventType"), new LocalizedText("en", "RefreshRequiredEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode89() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2790"), new QualifiedName(0, "AuditConditionEventType"), new LocalizedText("en", "AuditConditionEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode90() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2803"), new QualifiedName(0, "AuditConditionEnableEventType"), new LocalizedText("en", "AuditConditionEnableEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode91() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2829"), new QualifiedName(0, "AuditConditionCommentEventType"), new LocalizedText("en", "AuditConditionCommentEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode92() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2830"), new QualifiedName(0, "DialogConditionType"), new LocalizedText("en", "DialogConditionType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode93() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2881"), new QualifiedName(0, "AcknowledgeableConditionType"), new LocalizedText("en", "AcknowledgeableConditionType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode94() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=11093"), new QualifiedName(0, "AuditConditionShelvingEventType"), new LocalizedText("en", "AuditConditionShelvingEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode95() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2915"), new QualifiedName(0, "AlarmConditionType"), new LocalizedText("en", "AlarmConditionType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode96() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2929"), new QualifiedName(0, "ShelvedStateMachineType"), new LocalizedText("en", "ShelvedStateMachineType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode97() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2955"), new QualifiedName(0, "LimitAlarmType"), new LocalizedText("en", "LimitAlarmType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode98() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=11163"), new QualifiedName(0, "BaseConditionClassType"), new LocalizedText("en", "BaseConditionClassType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode99() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=11164"), new QualifiedName(0, "ProcessConditionClassType"), new LocalizedText("en", "ProcessConditionClassType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode100() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=11165"), new QualifiedName(0, "MaintenanceConditionClassType"), new LocalizedText("en", "MaintenanceConditionClassType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode101() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=11166"), new QualifiedName(0, "SystemConditionClassType"), new LocalizedText("en", "SystemConditionClassType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode102() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=11187"), new QualifiedName(0, "AggregateConfigurationType"), new LocalizedText("en", "AggregateConfigurationType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode103() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=2999"), new QualifiedName(0, "AuditHistoryEventUpdateEventType"), new LocalizedText("en", "AuditHistoryEventUpdateEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode104() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=3006"), new QualifiedName(0, "AuditHistoryValueUpdateEventType"), new LocalizedText("en", "AuditHistoryValueUpdateEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode105() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=3012"), new QualifiedName(0, "AuditHistoryDeleteEventType"), new LocalizedText("en", "AuditHistoryDeleteEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode106() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=3014"), new QualifiedName(0, "AuditHistoryRawModifyDeleteEventType"), new LocalizedText("en", "AuditHistoryRawModifyDeleteEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode107() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=3019"), new QualifiedName(0, "AuditHistoryAtTimeDeleteEventType"), new LocalizedText("en", "AuditHistoryAtTimeDeleteEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode108() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=3022"), new QualifiedName(0, "AuditHistoryEventDeleteEventType"), new LocalizedText("en", "AuditHistoryEventDeleteEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode109() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=3035"), new QualifiedName(0, "EventQueueOverflowEventType"), new LocalizedText("en", "EventQueueOverflowEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode110() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=11436"), new QualifiedName(0, "ProgressEventType"), new LocalizedText("en", "ProgressEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode111() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=11446"), new QualifiedName(0, "SystemStatusChangeEventType"), new LocalizedText("en", "SystemStatusChangeEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), true);
    ...
    private void buildNode112() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=11564"), new QualifiedName(0, "OperationLimitsType"), new LocalizedText("en", "OperationLimitsType"), Optional.of(new LocalizedText("en", "Identifies the operation limits imposed by the server.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode113() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=11575"), new QualifiedName(0, "FileType"), new LocalizedText("en", "FileType"), Optional.of(new LocalizedText("en", "An object that represents a file that can be accessed via the server.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode114() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=11595"), new QualifiedName(0, "AddressSpaceFileType"), new LocalizedText("en", "AddressSpaceFileType"), Optional.of(new LocalizedText("en", "A file used to store a namespace exported from the server.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode115() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=11616"), new QualifiedName(0, "NamespaceMetadataType"), new LocalizedText("en", "NamespaceMetadataType"), Optional.of(new LocalizedText("en", "Provides the metadata for a namespace used by the server.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode116() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=11645"), new QualifiedName(0, "NamespacesType"), new LocalizedText("en", "NamespacesType"), Optional.of(new LocalizedText("en", "A container for the namespace metadata provided by the server.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode117() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=11753"), new QualifiedName(0, "SystemOffNormalAlarmType"), new LocalizedText("en", "SystemOffNormalAlarmType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode118() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=11856"), new QualifiedName(0, "AuditProgramTransitionEventType"), new LocalizedText("en", "AuditProgramTransitionEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode119() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=11945"), new QualifiedName(0, "NonTransparentNetworkRedundancyType"), new LocalizedText("en", "NonTransparentNetworkRedundancyType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
    ...
    private void buildNode120() {
        UaObjectTypeNode node = new UaObjectTypeNode(this.nodeManager, NodeId.parse("ns=0;i=3806"), new QualifiedName(0, "ProgramTransitionAuditEventType"), new LocalizedText("en", "ProgramTransitionAuditEventType"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), false);
