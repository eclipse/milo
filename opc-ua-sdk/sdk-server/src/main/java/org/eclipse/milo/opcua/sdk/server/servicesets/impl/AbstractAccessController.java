...
public abstract class AbstractAccessController {
    ...
    public AbstractAccessController(OpcUaServer server) {
        this.server = server;
    }

    protected static List<AccessResult> checkAccessRestrictions(
                ...
                if (accessRestrictions.getEncryptionRequired()) {
                    AccessResult result =
                        securityMode == MessageSecurityMode.SignAndEncrypt ?
                            AccessResult.ALLOWED : AccessResult.DENIED;
    ...
    public static class DefaultAccessControlContext implements AccessControlContext {
