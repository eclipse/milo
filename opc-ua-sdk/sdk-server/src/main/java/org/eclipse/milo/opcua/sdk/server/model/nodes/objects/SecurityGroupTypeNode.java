...
import org.eclipse.milo.opcua.sdk.server.model.types.objects.SecurityGroupType;
...
public class SecurityGroupTypeNode extends BaseObjectTypeNode implements SecurityGroupType {
    ...
    @Override
    public MethodNode getInvalidateKeysMethodNode() {
    ...
    @Override
    public MethodNode getForceKeyRotationMethodNode() {
