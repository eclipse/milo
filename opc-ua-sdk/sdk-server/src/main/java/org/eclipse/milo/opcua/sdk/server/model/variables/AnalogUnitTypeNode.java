...
public class AnalogUnitTypeNode extends BaseAnalogTypeNode implements AnalogUnitType {
    public AnalogUnitTypeNode(UaNodeContext context, NodeId nodeId, QualifiedName browseName,
    ...
    public PropertyTypeNode getEngineeringUnitsNode() {
        Optional<VariableNode> propertyNode = getPropertyNode(AnalogUnitType.ENGINEERING_UNITS);
        return (PropertyTypeNode) propertyNode.orElse(null);
    }

    @Override
    public EUInformation getEngineeringUnits() {
        return getProperty(AnalogUnitType.ENGINEERING_UNITS).orElse(null);
    }

    @Override
    public void setEngineeringUnits(EUInformation value) {
        setProperty(AnalogUnitType.ENGINEERING_UNITS, value);
    }
}
