...
import org.eclipse.milo.opcua.sdk.server.model.objects.AddressSpaceFileNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.AggregateConfigurationNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.AggregateFunctionNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.CertificateGroupFolderNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.CertificateGroupNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.DataTypeEncodingNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.DataTypeSystemNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.DirectoryNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.ExclusiveLimitStateMachineNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.FileDirectoryNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.FileNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.HistoricalDataConfigurationNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.HistoryServerCapabilitiesNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.ModellingRuleNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.NamespaceMetadataNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.NamespacesNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.OperationLimitsNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.ServerCapabilitiesNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.ServerConfigurationNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.ServerDiagnosticsNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.ServerNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.ServerRedundancyNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.SessionDiagnosticsObjectNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.SessionsDiagnosticsSummaryNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.ShelvedStateMachineNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.StateNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.TransitionNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.TrustListNode;
import org.eclipse.milo.opcua.sdk.server.model.objects.VendorServerInfoNode;
...
public class UaObjectLoader {
    ...
    private void buildNode0() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=8251"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode5() {
        UaObjectNode node = new DirectoryNode(this.nodeManager, NodeId.parse("ns=0;i=84"), new QualifiedName(0, "Root"), new LocalizedText("en", "Root"), Optional.of(new LocalizedText("en", "The root of the server address space.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode7() {
        UaObjectNode node = new DirectoryNode(this.nodeManager, NodeId.parse("ns=0;i=86"), new QualifiedName(0, "Types"), new LocalizedText("en", "Types"), Optional.of(new LocalizedText("en", "The browse entry point when looking for types in the server address space.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode8() {
        UaObjectNode node = new DirectoryNode(this.nodeManager, NodeId.parse("ns=0;i=87"), new QualifiedName(0, "Views"), new LocalizedText("en", "Views"), Optional.of(new LocalizedText("en", "The browse entry point when looking for views in the server address space.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode15() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=12505"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode16() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=12509"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode17() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=297"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode18() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=298"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode19() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=300"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode20() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=301"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode21() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=305"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode22() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=306"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode23() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=309"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode24() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=310"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode25() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=313"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode26() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=314"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode27() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=317"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode28() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=318"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode29() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=320"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode30() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=321"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode31() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=323"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode32() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=324"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode33() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=326"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode34() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=327"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode35() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=332"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode36() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=333"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode37() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=336"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode38() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=337"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode39() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=339"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode40() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=340"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode41() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=342"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode42() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=343"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode43() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=345"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode44() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=346"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode45() {
        UaObjectNode node = new ServerConfigurationNode(this.nodeManager, NodeId.parse("ns=0;i=12637"), new QualifiedName(0, "ServerConfiguration"), new LocalizedText("en", "ServerConfiguration"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode46() {
        UaObjectNode node = new TrustListNode(this.nodeManager, NodeId.parse("ns=0;i=12642"), new QualifiedName(0, "TrustList"), new LocalizedText("en", "TrustList"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode47() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=377"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode48() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=378"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode49() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=380"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode50() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=381"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode51() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=383"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode52() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=384"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode53() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=386"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode54() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=387"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode55() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=12676"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode56() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=12680"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode57() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=433"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode58() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=434"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode59() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=12757"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode60() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=12758"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode61() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=12765"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode62() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=12766"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode63() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=538"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode64() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=539"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode65() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=541"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode66() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=542"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode67() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=584"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode68() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=585"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode69() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=587"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode70() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=588"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode71() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=590"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode72() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=591"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode73() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=593"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode74() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=594"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode75() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=596"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode76() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=597"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode77() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=599"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode78() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=600"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode79() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=602"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode80() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=603"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode81() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=12892"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode82() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=12893"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode83() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=12900"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode84() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=12901"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode85() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=660"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode86() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=661"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode87() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=720"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode88() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=8913"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode89() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=721"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode90() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=8917"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode91() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=726"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode92() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=727"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode93() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=854"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode94() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=855"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode95() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=857"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode96() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=858"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode97() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=860"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode98() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=861"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode99() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=863"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode100() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=864"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode101() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=866"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode102() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=867"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode103() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=869"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode104() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=870"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode105() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=872"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode106() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=873"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode107() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=875"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode108() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=876"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode109() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=878"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode110() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=879"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode111() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=885"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode112() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=886"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode113() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=888"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode114() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=889"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode115() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=892"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode116() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=893"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode117() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=895"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode118() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=896"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode119() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=898"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode120() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=899"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode121() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=921"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode122() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=922"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode123() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=939"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode124() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=940"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode125() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=949"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode126() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=950"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode127() {
        UaObjectNode node = new ShelvedStateMachineNode(this.nodeManager, NodeId.parse("ns=0;i=9178"), new QualifiedName(0, "ShelvingState"), new LocalizedText("en", "ShelvingState"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode128() {
        UaObjectNode node = new FileDirectoryNode(this.nodeManager, NodeId.parse("ns=0;i=13354"), new QualifiedName(0, "<FileDirectoryName>"), new LocalizedText("en", "<FileDirectoryName>"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode129() {
        UaObjectNode node = new FileNode(this.nodeManager, NodeId.parse("ns=0;i=13366"), new QualifiedName(0, "<FileName>"), new LocalizedText("en", "<FileName>"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode130() {
        UaObjectNode node = new StateNode(this.nodeManager, NodeId.parse("ns=0;i=9329"), new QualifiedName(0, "HighHigh"), new LocalizedText("en", "HighHigh"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode131() {
        UaObjectNode node = new StateNode(this.nodeManager, NodeId.parse("ns=0;i=9331"), new QualifiedName(0, "High"), new LocalizedText("en", "High"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode132() {
        UaObjectNode node = new StateNode(this.nodeManager, NodeId.parse("ns=0;i=9333"), new QualifiedName(0, "Low"), new LocalizedText("en", "Low"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode133() {
        UaObjectNode node = new StateNode(this.nodeManager, NodeId.parse("ns=0;i=9335"), new QualifiedName(0, "LowLow"), new LocalizedText("en", "LowLow"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode134() {
        UaObjectNode node = new TransitionNode(this.nodeManager, NodeId.parse("ns=0;i=9337"), new QualifiedName(0, "LowLowToLow"), new LocalizedText("en", "LowLowToLow"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode135() {
        UaObjectNode node = new TransitionNode(this.nodeManager, NodeId.parse("ns=0;i=9338"), new QualifiedName(0, "LowToLowLow"), new LocalizedText("en", "LowToLowLow"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode136() {
        UaObjectNode node = new TransitionNode(this.nodeManager, NodeId.parse("ns=0;i=9339"), new QualifiedName(0, "HighHighToHigh"), new LocalizedText("en", "HighHighToHigh"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode137() {
        UaObjectNode node = new TransitionNode(this.nodeManager, NodeId.parse("ns=0;i=9340"), new QualifiedName(0, "HighToHighHigh"), new LocalizedText("en", "HighToHighHigh"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode138() {
        UaObjectNode node = new ExclusiveLimitStateMachineNode(this.nodeManager, NodeId.parse("ns=0;i=9455"), new QualifiedName(0, "LimitState"), new LocalizedText("en", "LimitState"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode139() {
        UaObjectNode node = new TrustListNode(this.nodeManager, NodeId.parse("ns=0;i=13599"), new QualifiedName(0, "TrustList"), new LocalizedText("en", "TrustList"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode140() {
        UaObjectNode node = new CertificateGroupNode(this.nodeManager, NodeId.parse("ns=0;i=13814"), new QualifiedName(0, "DefaultApplicationGroup"), new LocalizedText("en", "DefaultApplicationGroup"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode141() {
        UaObjectNode node = new TrustListNode(this.nodeManager, NodeId.parse("ns=0;i=13815"), new QualifiedName(0, "TrustList"), new LocalizedText("en", "TrustList"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode142() {
        UaObjectNode node = new CertificateGroupNode(this.nodeManager, NodeId.parse("ns=0;i=13848"), new QualifiedName(0, "DefaultHttpsGroup"), new LocalizedText("en", "DefaultHttpsGroup"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode143() {
        UaObjectNode node = new TrustListNode(this.nodeManager, NodeId.parse("ns=0;i=13849"), new QualifiedName(0, "TrustList"), new LocalizedText("en", "TrustList"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode144() {
        UaObjectNode node = new CertificateGroupNode(this.nodeManager, NodeId.parse("ns=0;i=13882"), new QualifiedName(0, "DefaultUserTokenGroup"), new LocalizedText("en", "DefaultUserTokenGroup"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode145() {
        UaObjectNode node = new TrustListNode(this.nodeManager, NodeId.parse("ns=0;i=13883"), new QualifiedName(0, "TrustList"), new LocalizedText("en", "TrustList"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode146() {
        UaObjectNode node = new CertificateGroupNode(this.nodeManager, NodeId.parse("ns=0;i=13916"), new QualifiedName(0, "<CertificateGroup>"), new LocalizedText("en", "<CertificateGroup>"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode147() {
        UaObjectNode node = new TrustListNode(this.nodeManager, NodeId.parse("ns=0;i=13917"), new QualifiedName(0, "TrustList"), new LocalizedText("en", "TrustList"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode148() {
        UaObjectNode node = new CertificateGroupFolderNode(this.nodeManager, NodeId.parse("ns=0;i=13950"), new QualifiedName(0, "CertificateGroups"), new LocalizedText("en", "CertificateGroups"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode149() {
        UaObjectNode node = new CertificateGroupNode(this.nodeManager, NodeId.parse("ns=0;i=13951"), new QualifiedName(0, "DefaultApplicationGroup"), new LocalizedText("en", "DefaultApplicationGroup"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode150() {
        UaObjectNode node = new TrustListNode(this.nodeManager, NodeId.parse("ns=0;i=13952"), new QualifiedName(0, "TrustList"), new LocalizedText("en", "TrustList"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode151() {
        UaObjectNode node = new CertificateGroupFolderNode(this.nodeManager, NodeId.parse("ns=0;i=14053"), new QualifiedName(0, "CertificateGroups"), new LocalizedText("en", "CertificateGroups"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode152() {
        UaObjectNode node = new CertificateGroupNode(this.nodeManager, NodeId.parse("ns=0;i=14088"), new QualifiedName(0, "DefaultHttpsGroup"), new LocalizedText("en", "DefaultHttpsGroup"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode153() {
        UaObjectNode node = new TrustListNode(this.nodeManager, NodeId.parse("ns=0;i=14089"), new QualifiedName(0, "TrustList"), new LocalizedText("en", "TrustList"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode154() {
        UaObjectNode node = new CertificateGroupNode(this.nodeManager, NodeId.parse("ns=0;i=14122"), new QualifiedName(0, "DefaultUserTokenGroup"), new LocalizedText("en", "DefaultUserTokenGroup"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode155() {
        UaObjectNode node = new TrustListNode(this.nodeManager, NodeId.parse("ns=0;i=14123"), new QualifiedName(0, "TrustList"), new LocalizedText("en", "TrustList"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode156() {
        UaObjectNode node = new CertificateGroupNode(this.nodeManager, NodeId.parse("ns=0;i=14156"), new QualifiedName(0, "DefaultApplicationGroup"), new LocalizedText("en", "DefaultApplicationGroup"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode162() {
        UaObjectNode node = new ServerNode(this.nodeManager, NodeId.parse("ns=0;i=2253"), new QualifiedName(0, "Server"), new LocalizedText("en", "Server"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(1));
    ...
    private void buildNode163() {
        UaObjectNode node = new ServerCapabilitiesNode(this.nodeManager, NodeId.parse("ns=0;i=2268"), new QualifiedName(0, "ServerCapabilities"), new LocalizedText("en", "ServerCapabilities"), Optional.of(new LocalizedText("en", "Describes capabilities supported by the server.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode164() {
        UaObjectNode node = new ServerDiagnosticsNode(this.nodeManager, NodeId.parse("ns=0;i=2274"), new QualifiedName(0, "ServerDiagnostics"), new LocalizedText("en", "ServerDiagnostics"), Optional.of(new LocalizedText("en", "Reports diagnostics about the server.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode165() {
        UaObjectNode node = new VendorServerInfoNode(this.nodeManager, NodeId.parse("ns=0;i=2295"), new QualifiedName(0, "VendorServerInfo"), new LocalizedText("en", "VendorServerInfo"), Optional.of(new LocalizedText("en", "Server information provided by the vendor.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode166() {
        UaObjectNode node = new ServerRedundancyNode(this.nodeManager, NodeId.parse("ns=0;i=2296"), new QualifiedName(0, "ServerRedundancy"), new LocalizedText("en", "ServerRedundancy"), Optional.of(new LocalizedText("en", "Describes the redundancy capabilities of the server.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode176() {
        UaObjectNode node = new AggregateFunctionNode(this.nodeManager, NodeId.parse("ns=0;i=2351"), new QualifiedName(0, "AnnotationCount"), new LocalizedText("en", "AnnotationCount"), Optional.of(new LocalizedText("en", "Retrieve the number of Annotations in the interval.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode177() {
        UaObjectNode node = new AggregateFunctionNode(this.nodeManager, NodeId.parse("ns=0;i=2352"), new QualifiedName(0, "Count"), new LocalizedText("en", "Count"), Optional.of(new LocalizedText("en", "Retrieve the number of raw values over the interval.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode180() {
        UaObjectNode node = new AggregateFunctionNode(this.nodeManager, NodeId.parse("ns=0;i=2358"), new QualifiedName(0, "End"), new LocalizedText("en", "End"), Optional.of(new LocalizedText("en", "Retrieve the value at the end of the interval using Interpolated Bounding Values.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode187() {
        UaObjectNode node = new StateNode(this.nodeManager, NodeId.parse("ns=0;i=2400"), new QualifiedName(0, "Ready"), new LocalizedText("en", "Ready"), Optional.of(new LocalizedText("en", "The Program is properly initialized and may be started.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode188() {
        UaObjectNode node = new StateNode(this.nodeManager, NodeId.parse("ns=0;i=2402"), new QualifiedName(0, "Running"), new LocalizedText("en", "Running"), Optional.of(new LocalizedText("en", "The Program is executing making progress towards completion.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode191() {
        UaObjectNode node = new TransitionNode(this.nodeManager, NodeId.parse("ns=0;i=2408"), new QualifiedName(0, "HaltedToReady"), new LocalizedText("en", "HaltedToReady"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode192() {
        UaObjectNode node = new TransitionNode(this.nodeManager, NodeId.parse("ns=0;i=2410"), new QualifiedName(0, "ReadyToRunning"), new LocalizedText("en", "ReadyToRunning"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode193() {
        UaObjectNode node = new TransitionNode(this.nodeManager, NodeId.parse("ns=0;i=2412"), new QualifiedName(0, "RunningToHalted"), new LocalizedText("en", "RunningToHalted"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode194() {
        UaObjectNode node = new TransitionNode(this.nodeManager, NodeId.parse("ns=0;i=2414"), new QualifiedName(0, "RunningToReady"), new LocalizedText("en", "RunningToReady"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode195() {
        UaObjectNode node = new TransitionNode(this.nodeManager, NodeId.parse("ns=0;i=2416"), new QualifiedName(0, "RunningToSuspended"), new LocalizedText("en", "RunningToSuspended"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode196() {
        UaObjectNode node = new TransitionNode(this.nodeManager, NodeId.parse("ns=0;i=2418"), new QualifiedName(0, "SuspendedToRunning"), new LocalizedText("en", "SuspendedToRunning"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode197() {
        UaObjectNode node = new TransitionNode(this.nodeManager, NodeId.parse("ns=0;i=2420"), new QualifiedName(0, "SuspendedToHalted"), new LocalizedText("en", "SuspendedToHalted"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode198() {
        UaObjectNode node = new TransitionNode(this.nodeManager, NodeId.parse("ns=0;i=2422"), new QualifiedName(0, "SuspendedToReady"), new LocalizedText("en", "SuspendedToReady"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode199() {
        UaObjectNode node = new TransitionNode(this.nodeManager, NodeId.parse("ns=0;i=2424"), new QualifiedName(0, "ReadyToHalted"), new LocalizedText("en", "ReadyToHalted"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode202() {
        UaObjectNode node = new StateNode(this.nodeManager, NodeId.parse("ns=0;i=2930"), new QualifiedName(0, "Unshelved"), new LocalizedText("en", "Unshelved"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode203() {
        UaObjectNode node = new StateNode(this.nodeManager, NodeId.parse("ns=0;i=2932"), new QualifiedName(0, "TimedShelved"), new LocalizedText("en", "TimedShelved"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode204() {
        UaObjectNode node = new StateNode(this.nodeManager, NodeId.parse("ns=0;i=2933"), new QualifiedName(0, "OneShotShelved"), new LocalizedText("en", "OneShotShelved"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode205() {
        UaObjectNode node = new TransitionNode(this.nodeManager, NodeId.parse("ns=0;i=2935"), new QualifiedName(0, "UnshelvedToTimedShelved"), new LocalizedText("en", "UnshelvedToTimedShelved"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode206() {
        UaObjectNode node = new TransitionNode(this.nodeManager, NodeId.parse("ns=0;i=2936"), new QualifiedName(0, "UnshelvedToOneShotShelved"), new LocalizedText("en", "UnshelvedToOneShotShelved"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode207() {
        UaObjectNode node = new TransitionNode(this.nodeManager, NodeId.parse("ns=0;i=2940"), new QualifiedName(0, "TimedShelvedToUnshelved"), new LocalizedText("en", "TimedShelvedToUnshelved"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode208() {
        UaObjectNode node = new TransitionNode(this.nodeManager, NodeId.parse("ns=0;i=2942"), new QualifiedName(0, "TimedShelvedToOneShotShelved"), new LocalizedText("en", "TimedShelvedToOneShotShelved"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode209() {
        UaObjectNode node = new TransitionNode(this.nodeManager, NodeId.parse("ns=0;i=2943"), new QualifiedName(0, "OneShotShelvedToUnshelved"), new LocalizedText("en", "OneShotShelvedToUnshelved"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode210() {
        UaObjectNode node = new TransitionNode(this.nodeManager, NodeId.parse("ns=0;i=2945"), new QualifiedName(0, "OneShotShelvedToTimedShelved"), new LocalizedText("en", "OneShotShelvedToTimedShelved"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode211() {
        UaObjectNode node = new DirectoryNode(this.nodeManager, NodeId.parse("ns=0;i=11172"), new QualifiedName(0, "AggregateFunctions"), new LocalizedText("en", "AggregateFunctions"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode212() {
        UaObjectNode node = new DirectoryNode(this.nodeManager, NodeId.parse("ns=0;i=2996"), new QualifiedName(0, "ModellingRules"), new LocalizedText("en", "ModellingRules"), Optional.of(new LocalizedText("en", "A folder for the modelling rules supported by the server.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode213() {
        UaObjectNode node = new DirectoryNode(this.nodeManager, NodeId.parse("ns=0;i=2997"), new QualifiedName(0, "AggregateFunctions"), new LocalizedText("en", "AggregateFunctions"), Optional.of(new LocalizedText("en", "A folder for the real time aggregates supported by the server.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode214() {
        UaObjectNode node = new HistoryServerCapabilitiesNode(this.nodeManager, NodeId.parse("ns=0;i=11192"), new QualifiedName(0, "HistoryServerCapabilities"), new LocalizedText("en", "HistoryServerCapabilities"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode215() {
        UaObjectNode node = new DirectoryNode(this.nodeManager, NodeId.parse("ns=0;i=11201"), new QualifiedName(0, "AggregateFunctions"), new LocalizedText("en", "AggregateFunctions"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode216() {
        UaObjectNode node = new HistoricalDataConfigurationNode(this.nodeManager, NodeId.parse("ns=0;i=11202"), new QualifiedName(0, "HA Configuration"), new LocalizedText("en", "HA Configuration"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode217() {
        UaObjectNode node = new AggregateConfigurationNode(this.nodeManager, NodeId.parse("ns=0;i=11203"), new QualifiedName(0, "AggregateConfiguration"), new LocalizedText("en", "AggregateConfiguration"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode218() {
        UaObjectNode node = new DirectoryNode(this.nodeManager, NodeId.parse("ns=0;i=3048"), new QualifiedName(0, "EventTypes"), new LocalizedText("en", "EventTypes"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode219() {
        UaObjectNode node = new AggregateConfigurationNode(this.nodeManager, NodeId.parse("ns=0;i=3059"), new QualifiedName(0, "AggregateConfiguration"), new LocalizedText("en", "AggregateConfiguration"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode220() {
        UaObjectNode node = new DirectoryNode(this.nodeManager, NodeId.parse("ns=0;i=3062"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.of(new LocalizedText("en", "The default binary encoding for a data type.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode221() {
        UaObjectNode node = new DirectoryNode(this.nodeManager, NodeId.parse("ns=0;i=3063"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.of(new LocalizedText("en", "The default XML encoding for a data type.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode222() {
        UaObjectNode node = new DirectoryNode(this.nodeManager, NodeId.parse("ns=0;i=3093"), new QualifiedName(0, "ModellingRules"), new LocalizedText("en", "ModellingRules"), Optional.of(new LocalizedText("en", "A folder for the modelling rules supported by the server.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode224() {
        UaObjectNode node = new DirectoryNode(this.nodeManager, NodeId.parse("ns=0;i=3094"), new QualifiedName(0, "AggregateFunctions"), new LocalizedText("en", "AggregateFunctions"), Optional.of(new LocalizedText("en", "A folder for the real time aggregates supported by the server.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode240() {
        UaObjectNode node = new AggregateFunctionNode(this.nodeManager, NodeId.parse("ns=0;i=11506"), new QualifiedName(0, "EndBound"), new LocalizedText("en", "EndBound"), Optional.of(new LocalizedText("en", "Retrieve the value at the end of the interval using Simple Bounding Values.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode244() {
        UaObjectNode node = new NamespacesNode(this.nodeManager, NodeId.parse("ns=0;i=11527"), new QualifiedName(0, "Namespaces"), new LocalizedText("en", "Namespaces"), Optional.of(new LocalizedText("en", "Describes the namespaces supported by the server.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode247() {
        UaObjectNode node = new NamespaceMetadataNode(this.nodeManager, NodeId.parse("ns=0;i=11646"), new QualifiedName(0, "<NamespaceIdentifier>"), new LocalizedText("en", "<NamespaceIdentifier>"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode248() {
        UaObjectNode node = new AddressSpaceFileNode(this.nodeManager, NodeId.parse("ns=0;i=11675"), new QualifiedName(0, "AddressSpaceFile"), new LocalizedText("en", "AddressSpaceFile"), Optional.of(new LocalizedText("en", "A file containing the nodes of the namespace.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode250() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=7616"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode251() {
        UaObjectNode node = new NamespacesNode(this.nodeManager, NodeId.parse("ns=0;i=11715"), new QualifiedName(0, "Namespaces"), new LocalizedText("en", "Namespaces"), Optional.of(new LocalizedText("en", "Describes the namespaces supported by the server.")), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode252() {
        UaObjectNode node = new DirectoryNode(this.nodeManager, NodeId.parse("ns=0;i=11876"), new QualifiedName(0, "AggregateFunctions"), new LocalizedText("en", "AggregateFunctions"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode254() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=11949"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode255() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=11950"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode256() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=11957"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode257() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=11958"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode258() {
        UaObjectNode node = new DirectoryNode(this.nodeManager, NodeId.parse("ns=0;i=3850"), new QualifiedName(0, "FinalResultData"), new LocalizedText("en", "FinalResultData"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode259() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=12081"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode260() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=12082"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode261() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=12089"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode262() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=12090"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode263() {
        UaObjectNode node = new SessionDiagnosticsObjectNode(this.nodeManager, NodeId.parse("ns=0;i=12097"), new QualifiedName(0, "<SessionPlaceholder>"), new LocalizedText("en", "<SessionPlaceholder>"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode264() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=12173"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode265() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=12174"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode266() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=12181"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode267() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=12182"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode268() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=12195"), new QualifiedName(0, "Default XML"), new LocalizedText("en", "Default XML"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
    ...
    private void buildNode269() {
        UaObjectNode node = new DataTypeEncodingNode(this.nodeManager, NodeId.parse("ns=0;i=12207"), new QualifiedName(0, "Default Binary"), new LocalizedText("en", "Default Binary"), Optional.empty(), Optional.of(UInteger.valueOf(0L)), Optional.of(UInteger.valueOf(0L)), UByte.valueOf(0));
