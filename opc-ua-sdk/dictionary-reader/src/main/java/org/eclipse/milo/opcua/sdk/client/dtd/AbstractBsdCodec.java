...
public abstract class AbstractBsdCodec<StructureT, MemberT> implements OpcUaBinaryDataTypeCodec {
    ...
    private Object decode(
        ...
        if (dictionary != null) {
            Object typeDescription = dictionary.getTypeDescription(description);
