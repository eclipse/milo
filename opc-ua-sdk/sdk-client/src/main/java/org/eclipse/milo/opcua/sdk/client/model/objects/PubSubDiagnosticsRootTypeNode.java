...
public class PubSubDiagnosticsRootTypeNode extends PubSubDiagnosticsTypeNode implements PubSubDiagnosticsRootType {
    public PubSubDiagnosticsRootTypeNode(OpcUaClient client, NodeId nodeId, NodeClass nodeClass,
