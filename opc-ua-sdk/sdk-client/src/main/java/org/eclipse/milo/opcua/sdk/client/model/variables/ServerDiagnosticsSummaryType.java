...
public interface ServerDiagnosticsSummaryType extends BaseDataVariableType {
    ...
    /**
     * Read the value of the ServerViewCount Node from the server and update the local value if
    ...
    /**
     * Read the value of the SecurityRejectedSessionCount Node from the server and update the local value if
     * the operation succeeds.
     *
     * @return the {@link UInteger} value read from the server.
     * @throws UaException if a service- or operation-level error occurs.
    ...
    /**
     * Read the value of the SessionAbortCount Node from the server and update the local value if
     * the operation succeeds.
     *
     * @return the {@link UInteger} value read from the server.
     * @throws UaException if a service- or operation-level error occurs.
    ...
    /**
     * Read the value of the PublishingIntervalCount Node from the server and update the local value if
     * the operation succeeds.
     *
     * @return the {@link UInteger} value read from the server.
     * @throws UaException if a service- or operation-level error occurs.
    ...
    /**
     * Read the value of the CurrentSubscriptionCount Node from the server and update the local value if
     * the operation succeeds.
     *
     * @return the {@link UInteger} value read from the server.
     * @throws UaException if a service- or operation-level error occurs.
    ...
    /**
     * Read the value of the CumulatedSubscriptionCount Node from the server and update the local value if
     * the operation succeeds.
     *
     * @return the {@link UInteger} value read from the server.
     * @throws UaException if a service- or operation-level error occurs.
    ...
    /**
     * Read the value of the SecurityRejectedRequestsCount Node from the server and update the local value if
     * the operation succeeds.
     *
     * @return the {@link UInteger} value read from the server.
     * @throws UaException if a service- or operation-level error occurs.
