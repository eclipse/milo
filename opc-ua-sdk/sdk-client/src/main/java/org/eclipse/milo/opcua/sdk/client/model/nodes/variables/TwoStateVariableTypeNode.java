...
public class TwoStateVariableTypeNode extends StateVariableTypeNode implements TwoStateVariableType {
    public TwoStateVariableTypeNode(OpcUaClient client, NodeId nodeId) {
        super(client, nodeId);
    }

    public CompletableFuture<PropertyTypeNode> getIdNode() {
    ...
    public CompletableFuture<PropertyTypeNode> getTransitionTimeNode() {
    ...
    public CompletableFuture<PropertyTypeNode> getEffectiveTransitionTimeNode() {
    ...
    public CompletableFuture<PropertyTypeNode> getTrueStateNode() {
    ...
    public CompletableFuture<PropertyTypeNode> getFalseStateNode() {
