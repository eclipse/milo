...
public interface ArrayItemType extends DataItemType {
    ...
    /**
     * Read the value of the Title Node from the server and update the local value if
     * the operation succeeds.
     *
    ...
    /**
     * Read the value of the AxisScaleType Node from the server and update the local value if
     * the operation succeeds.
     *
