...
public interface ServerType extends BaseObjectType {
    ...
    /**
     * Read the value of the ServerArray Node from the server and update the local value if
    ...
    /**
     * Read the value of the NamespaceArray Node from the server and update the local value if
     * the operation succeeds.
     *
     * @return the {@link String[]} value read from the server.
     * @throws UaException if a service- or operation-level error occurs.
    ...
    /**
     * Read the value of the UrisVersion Node from the server and update the local value if
     * the operation succeeds.
     *
    ...
    /**
     * Write a new value for the UrisVersion Node to the server and update the local value if
     * the operation succeeds.
     *
    ...
    /**
     * Read the value of the ServiceLevel Node from the server and update the local value if
     * the operation succeeds.
     *
    ...
    /**
     * Read the value of the Auditing Node from the server and update the local value if
     * the operation succeeds.
     *
    ...
    /**
     * Read the value of the ServerStatus Node from the server and update the local value if
     * the operation succeeds.
     *
     ...
     *
     * @return a CompletableFuture that completes successfully with the
     * ServerStatusType Node or completes exceptionally if an error occurs creating or
     * getting the Node.
     */
     ...
     *
     * @return a CompletableFuture that completes successfully with the
     * ServerCapabilitiesType Node or completes exceptionally if an error occurs creating or
     * getting the Node.
     */
     ...
     *
     * @return a CompletableFuture that completes successfully with the
     * ServerDiagnosticsType Node or completes exceptionally if an error occurs creating or
     * getting the Node.
     */
     ...
     *
     * @return a CompletableFuture that completes successfully with the
     * VendorServerInfoType Node or completes exceptionally if an error occurs creating or
     * getting the Node.
     */
     ...
     *
     * @return a CompletableFuture that completes successfully with the
     * ServerRedundancyType Node or completes exceptionally if an error occurs creating or
     * getting the Node.
     */
     ...
     *
     * @return a CompletableFuture that completes successfully with the
     * NamespacesType Node or completes exceptionally if an error occurs creating or
     * getting the Node.
     */
