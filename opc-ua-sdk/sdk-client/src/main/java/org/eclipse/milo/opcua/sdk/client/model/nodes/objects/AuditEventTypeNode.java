...
public class AuditEventTypeNode extends BaseEventTypeNode implements AuditEventType {
    public AuditEventTypeNode(OpcUaClient client, NodeId nodeId) {
        super(client, nodeId);
    }

    public CompletableFuture<PropertyTypeNode> getActionTimeStampNode() {
    ...
    public CompletableFuture<PropertyTypeNode> getStatusNode() {
    ...
    public CompletableFuture<PropertyTypeNode> getServerIdNode() {
    ...
    public CompletableFuture<PropertyTypeNode> getClientAuditEntryIdNode() {
