...
public interface SessionDiagnosticsArrayType extends BaseDataVariableType {
    ...
    /**
     * Read the value of the SessionDiagnostics Node from the server and update the local value if
     ...
     * SessionDiagnosticsVariableType Node or completes exceptionally if an error occurs creating or
     * getting the Node.
     */
