...
public class ActivateSessionSuccessEvent implements Event {

    private final OpcUaSession session;
    private final CompletableFuture<OpcUaSession> sessionFuture;

    public ActivateSessionSuccessEvent(OpcUaSession session, CompletableFuture<OpcUaSession> sessionFuture) {
