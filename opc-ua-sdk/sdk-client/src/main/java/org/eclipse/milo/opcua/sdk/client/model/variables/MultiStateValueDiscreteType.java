...
public interface MultiStateValueDiscreteType extends DiscreteItemType {
    ...
    /**
     * Read the value of the EnumValues Node from the server and update the local value if
    ...
    /**
     * Read the value of the ValueAsText Node from the server and update the local value if
     * the operation succeeds.
     *
