...
public interface SubscriptionDiagnosticsArrayType extends BaseDataVariableType {
    ...
    /**
     * Read the value of the SubscriptionDiagnostics Node from the server and update the local value if
     ...
     * SubscriptionDiagnosticsType Node or completes exceptionally if an error occurs creating or
     * getting the Node.
     */
