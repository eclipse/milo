...
public class TransitionVariableTypeNode extends BaseDataVariableTypeNode implements TransitionVariableType {
    public TransitionVariableTypeNode(OpcUaClient client, NodeId nodeId) {
        super(client, nodeId);
    }
    ...
    public CompletableFuture<PropertyTypeNode> getNameNode() {
    ...
    public CompletableFuture<PropertyTypeNode> getNumberNode() {
