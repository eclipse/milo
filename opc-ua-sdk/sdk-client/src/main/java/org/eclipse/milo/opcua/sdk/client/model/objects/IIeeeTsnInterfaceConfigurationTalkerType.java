...
public interface IIeeeTsnInterfaceConfigurationTalkerType extends IIeeeTsnInterfaceConfigurationType {
    ...
    /**
     * Read the value of the TimeAwareOffset Node from the server and update the local value if
    ...
    /**
     * Write a new value for the TimeAwareOffset Node to the server and update the local value if
     * the operation succeeds.
     *
    ...
    /**
     * Get the TimeAwareOffset {@link BaseDataVariableType} Node, or {@code null} if it does not exist.
     * <p>
     * The Node is created when first accessed and cached for subsequent calls.
     *
     * @return the TimeAwareOffset {@link BaseDataVariableType} Node, or {@code null} if it does not exist.
