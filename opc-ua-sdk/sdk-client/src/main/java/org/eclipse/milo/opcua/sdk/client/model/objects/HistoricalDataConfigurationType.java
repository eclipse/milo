...
public interface HistoricalDataConfigurationType extends BaseObjectType {
    ...
    /**
     * Read the value of the Stepped Node from the server and update the local value if
    ...
    /**
     * Read the value of the MaxTimeInterval Node from the server and update the local value if
     * the operation succeeds.
     *
    ...
    /**
     * Read the value of the MinTimeInterval Node from the server and update the local value if
     * the operation succeeds.
     *
     * @return the {@link Double} value read from the server.
     * @throws UaException if a service- or operation-level error occurs.
    ...
    /**
     * Read the value of the ExceptionDeviation Node from the server and update the local value if
     * the operation succeeds.
     *
     * @return the {@link Double} value read from the server.
     * @throws UaException if a service- or operation-level error occurs.
    ...
    /**
     * Read the value of the ExceptionDeviationFormat Node from the server and update the local value if
     * the operation succeeds.
     *
    ...
    /**
     * Read the value of the StartOfArchive Node from the server and update the local value if
     * the operation succeeds.
     *
     ...
     *
     * @return a CompletableFuture that completes successfully with the
     * AggregateConfigurationType Node or completes exceptionally if an error occurs creating or
     * getting the Node.
     */
