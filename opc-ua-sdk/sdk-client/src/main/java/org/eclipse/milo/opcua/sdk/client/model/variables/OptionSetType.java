...
public interface OptionSetType extends BaseDataVariableType {
    ...
    /**
     * Read the value of the OptionSetValues Node from the server and update the local value if
    ...
    /**
     * Read the value of the BitMask Node from the server and update the local value if
     * the operation succeeds.
     *
