...
public class ExclusiveLimitAlarmTypeNode extends LimitAlarmTypeNode implements ExclusiveLimitAlarmType {
    public ExclusiveLimitAlarmTypeNode(OpcUaClient client, NodeId nodeId) {
        super(client, nodeId);
    }
    ...
    @Override
    public CompletableFuture<ExclusiveLimitStateMachineTypeNode> getLimitStateNode() {
        return getObjectComponent("http://opcfoundation.org/UA/", "LimitState").thenApply(ExclusiveLimitStateMachineTypeNode.class::cast);
    }
}
