...
public interface ServerStatusType extends BaseDataVariableType {
    ...
    /**
     * Read the value of the CurrentTime Node from the server and update the local value if
     * the operation succeeds.
     *
     * @return the {@link DateTime} value read from the server.
     * @throws UaException if a service- or operation-level error occurs.
    ...
    /**
     * Read the value of the BuildInfo Node from the server and update the local value if
     * the operation succeeds.
     *
     ...
     *
     * @return a CompletableFuture that completes successfully with the
     * BuildInfoType Node or completes exceptionally if an error occurs creating or
     * getting the Node.
     */
    ...
    /**
     * Read the value of the ShutdownReason Node from the server and update the local value if
     * the operation succeeds.
     *
