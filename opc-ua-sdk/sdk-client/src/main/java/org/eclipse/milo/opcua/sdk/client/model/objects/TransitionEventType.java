...
public interface TransitionEventType extends BaseEventType {
    ...
    /**
     * Read the value of the Transition Node from the server and update the local value if
    ...
    /**
     * Read the value of the FromState Node from the server and update the local value if
     * the operation succeeds.
     *
     * @return the {@link LocalizedText} value read from the server.
     * @throws UaException if a service- or operation-level error occurs.
    ...
    /**
     * Read the value of the ToState Node from the server and update the local value if
     * the operation succeeds.
     *
     * @return the {@link LocalizedText} value read from the server.
     * @throws UaException if a service- or operation-level error occurs.
