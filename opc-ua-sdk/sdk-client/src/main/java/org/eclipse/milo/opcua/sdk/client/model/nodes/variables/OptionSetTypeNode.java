...
public class OptionSetTypeNode extends BaseDataVariableTypeNode implements OptionSetType {
    ...
    @Override
    public CompletableFuture<Unit> writeOptionSetValuesAsync(LocalizedText[] optionSetValues) {
    ...
    public CompletableFuture<? extends PropertyTypeNode> getOptionSetValuesNodeAsync() {
        CompletableFuture<UaNode> future = getMemberNodeAsync("http://opcfoundation.org/UA/", "OptionSetValues", ExpandedNodeId.parse("nsu=http://opcfoundation.org/UA/;i=68"), false);
    ...
    @Override
    public CompletableFuture<Unit> writeBitMaskAsync(Boolean[] bitMask) {
    ...
    public CompletableFuture<? extends PropertyTypeNode> getBitMaskNodeAsync() {
        CompletableFuture<UaNode> future = getMemberNodeAsync("http://opcfoundation.org/UA/", "BitMask", ExpandedNodeId.parse("nsu=http://opcfoundation.org/UA/;i=68"), false);
        return future.thenApply(node -> (PropertyTypeNode) node);
    }
}
