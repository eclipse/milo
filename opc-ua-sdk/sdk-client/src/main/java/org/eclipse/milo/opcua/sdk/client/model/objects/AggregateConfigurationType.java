...
public interface AggregateConfigurationType extends BaseObjectType {
    ...
    /**
     * Read the value of the PercentDataBad Node from the server and update the local value if
     * the operation succeeds.
     *
    ...
    /**
     * Read the value of the PercentDataGood Node from the server and update the local value if
     * the operation succeeds.
     *
     * @return the {@link UByte} value read from the server.
     * @throws UaException if a service- or operation-level error occurs.
