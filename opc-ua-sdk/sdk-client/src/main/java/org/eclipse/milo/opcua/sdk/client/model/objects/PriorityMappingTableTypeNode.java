...
public class PriorityMappingTableTypeNode extends BaseObjectTypeNode implements PriorityMappingTableType {
    public PriorityMappingTableTypeNode(OpcUaClient client, NodeId nodeId, NodeClass nodeClass,
    ...
    @Override
    public CompletableFuture<? extends PriorityMappingEntryType[]> readPriorityMapppingEntriesAsync(
    ) {
