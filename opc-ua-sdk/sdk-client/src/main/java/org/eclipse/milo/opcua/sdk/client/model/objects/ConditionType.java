...
public interface ConditionType extends BaseEventType {
    ...
    /**
     * Read the value of the ConditionName Node from the server and update the local value if
     * the operation succeeds.
     *
    ...
    /**
     * Read the value of the BranchId Node from the server and update the local value if
     * the operation succeeds.
     *
     * @return the {@link NodeId} value read from the server.
     * @throws UaException if a service- or operation-level error occurs.
    ...
    /**
     * Read the value of the Retain Node from the server and update the local value if
     * the operation succeeds.
     *
    ...
    /**
     * Write a new value for the SupportsFilteredRetain Node to the server and update the local value if
     * the operation succeeds.
     *
     * @param value the {@link Boolean} value to write to the server.
     * @throws UaException if a service- or operation-level error occurs.
     ...
     * The Node is created when first accessed and cached for subsequent calls.
     *
     * @return the SupportsFilteredRetain {@link PropertyType} Node, or {@code null} if it does not exist.
     * @throws UaException if an error occurs creating or getting the Node.
     */
    ...
    /**
     * Read the value of the Quality Node from the server and update the local value if
     * the operation succeeds.
     *
     ...
     *
     * @return a CompletableFuture that completes successfully with the
     * ConditionVariableType Node or completes exceptionally if an error occurs creating or
     * getting the Node.
     */
    ...
    /**
     * Read the value of the LastSeverity Node from the server and update the local value if
     * the operation succeeds.
     *
    ...
    /**
     * Read the value of the Comment Node from the server and update the local value if
     * the operation succeeds.
     *
     * @return the {@link LocalizedText} value read from the server.
     * @throws UaException if a service- or operation-level error occurs.
