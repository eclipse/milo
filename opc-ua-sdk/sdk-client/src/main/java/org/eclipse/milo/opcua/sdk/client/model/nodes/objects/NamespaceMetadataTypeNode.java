...
public class NamespaceMetadataTypeNode extends BaseObjectTypeNode implements NamespaceMetadataType {
    public NamespaceMetadataTypeNode(OpcUaClient client, NodeId nodeId) {
        super(client, nodeId);
    }
    ...
    public CompletableFuture<AddressSpaceFileTypeNode> getNamespaceFileNode() {
        return getObjectComponent("http://opcfoundation.org/UA/", "NamespaceFile").thenApply(AddressSpaceFileTypeNode.class::cast);
    }
}
