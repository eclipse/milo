...
public class IIeeeTsnVlanTagTypeNode extends BaseInterfaceTypeNode implements IIeeeTsnVlanTagType {
    public IIeeeTsnVlanTagTypeNode(OpcUaClient client, NodeId nodeId, NodeClass nodeClass,
    ...
    @Override
    public UByte getPriorityCodePoint() throws UaException {
        BaseDataVariableTypeNode node = getPriorityCodePointNode();
        return (UByte) node.getValue().getValue().getValue();
    }

    @Override
    public void setPriorityCodePoint(UByte value) throws UaException {
        BaseDataVariableTypeNode node = getPriorityCodePointNode();
        node.setValue(new Variant(value));
    }
    ...
    @Override
    public CompletableFuture<? extends UByte> readPriorityCodePointAsync() {
    ...
    @Override
    public CompletableFuture<StatusCode> writePriorityCodePointAsync(UByte priorityCodePoint) {
