...
public class AuditHistoryRawModifyDeleteEventTypeNode extends AuditHistoryDeleteEventTypeNode implements AuditHistoryRawModifyDeleteEventType {
    ...
    public CompletableFuture<PropertyTypeNode> getIsDeleteModifiedNode() {
    ...
    public CompletableFuture<PropertyTypeNode> getStartTimeNode() {
    ...
    public CompletableFuture<PropertyTypeNode> getEndTimeNode() {
