 ...
 */
public class HistoryUpdateResponse extends Structure implements UaResponseMessageType {
    public static final ExpandedNodeId TYPE_ID = ExpandedNodeId.parse("ns=0;i=701");

    public static final ExpandedNodeId BINARY_ENCODING_ID = ExpandedNodeId.parse("i=703");

    public static final ExpandedNodeId XML_ENCODING_ID = ExpandedNodeId.parse("i=702");

    public static final ExpandedNodeId JSON_ENCODING_ID = ExpandedNodeId.parse("i=15288");

    private final ResponseHeader responseHeader;

    private final HistoryUpdateResult @Nullable [] results;

    private final DiagnosticInfo @Nullable [] diagnosticInfos;

    public HistoryUpdateResponse(ResponseHeader responseHeader,
                                 HistoryUpdateResult @Nullable [] results, DiagnosticInfo @Nullable [] diagnosticInfos) {
    ...
    public HistoryUpdateResult @Nullable [] getResults() {
        return results;
    }
    ...
    public boolean equals(Object object) {
        ...
        HistoryUpdateResponse that = (HistoryUpdateResponse) object;
    ...
    public String toString() {
        var joiner = new StringJoiner(", ", HistoryUpdateResponse.class.getSimpleName() + "[", "]");
    ...
    public static StructureDefinition definition(NamespaceTable namespaceTable) {
        return new StructureDefinition(
            ...
            new StructureField[]{
                ...
                new StructureField("Results", LocalizedText.NULL_VALUE, new NodeId(0, 695), 1, null, UInteger.valueOf(0), false),
    ...
    public static final class Codec extends GenericDataTypeCodec<HistoryUpdateResponse> {
        ...
        @Override
        public HistoryUpdateResponse decodeType(EncodingContext context, UaDecoder decoder) {
            ResponseHeader responseHeader = (ResponseHeader) decoder.decodeStruct("ResponseHeader", ResponseHeader.TYPE_ID);
            HistoryUpdateResult[] results = (HistoryUpdateResult[]) decoder.decodeStructArray("Results", HistoryUpdateResult.TYPE_ID);
        ...
        public void encodeType(EncodingContext context, UaEncoder encoder,
            ...
            encoder.encodeStructArray("Results", value.getResults(), HistoryUpdateResult.TYPE_ID);
