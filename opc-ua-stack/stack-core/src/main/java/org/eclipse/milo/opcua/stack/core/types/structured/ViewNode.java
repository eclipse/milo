...
public class ViewNode extends InstanceNode implements UaStructuredType {
    ...
    public static final ExpandedNodeId BINARY_ENCODING_ID = ExpandedNodeId.parse("i=281");

    public static final ExpandedNodeId XML_ENCODING_ID = ExpandedNodeId.parse("i=280");

    public static final ExpandedNodeId JSON_ENCODING_ID = ExpandedNodeId.parse("i=15078");
    ...
    public ViewNode(NodeId nodeId, NodeClass nodeClass, QualifiedName browseName,
                    ...
                    ReferenceNode @Nullable [] references, Boolean containsNoLoops, UByte eventNotifier) {
    ...
    public static final class Codec extends GenericDataTypeCodec<ViewNode> {
        ...
        public ViewNode decodeType(EncodingContext context, UaDecoder decoder) {
            ...
            return new ViewNode(nodeId, nodeClass, browseName, displayName, description, writeMask, userWriteMask, rolePermissions, userRolePermissions, accessRestrictions, references, containsNoLoops, eventNotifier);
        }
