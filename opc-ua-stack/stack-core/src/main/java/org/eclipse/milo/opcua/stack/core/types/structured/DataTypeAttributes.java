 ...
 */
public class DataTypeAttributes extends NodeAttributes implements UaStructuredType {
    ...
    public String toString() {
        var joiner = new StringJoiner(", ", DataTypeAttributes.class.getSimpleName() + "[", "]");
    ...
    public static final class Codec extends GenericDataTypeCodec<DataTypeAttributes> {
        ...
        @Override
        public DataTypeAttributes decodeType(EncodingContext context, UaDecoder decoder) {
        ...
        @Override
        public void encodeType(EncodingContext context, UaEncoder encoder, DataTypeAttributes value) {
