...
public class DeleteReferencesResponse extends Structure implements UaResponseMessageType {
    ...
    public DeleteReferencesResponse(ResponseHeader responseHeader, StatusCode @Nullable [] results,
    ...
    public boolean equals(Object object) {
        ...
        DeleteReferencesResponse that = (DeleteReferencesResponse) object;
    ...
    public String toString() {
        var joiner = new StringJoiner(", ", DeleteReferencesResponse.class.getSimpleName() + "[", "]");
    ...
    public static final class Codec extends GenericDataTypeCodec<DeleteReferencesResponse> {
        ...
        @Override
        public DeleteReferencesResponse decodeType(EncodingContext context, UaDecoder decoder) {
