...
public class ObjectTypeNode extends TypeNode implements UaStructure {
    ...
    public static final ExpandedNodeId BINARY_ENCODING_ID = ExpandedNodeId.parse("i=266");

    public static final ExpandedNodeId XML_ENCODING_ID = ExpandedNodeId.parse("i=265");

    public static final ExpandedNodeId JSON_ENCODING_ID = ExpandedNodeId.parse("i=15073");
    ...
    public static final class Codec extends GenericDataTypeCodec<ObjectTypeNode> {
        ...
        @Override
        public ObjectTypeNode decodeType(SerializationContext context, UaDecoder decoder) {
        ...
        @Override
        public void encodeType(SerializationContext context, UaEncoder encoder, ObjectTypeNode value) {
