...
public enum BrowseDirection implements UaEnumeration {
    ...
    public static final class Codec extends GenericDataTypeCodec<BrowseDirection> {
        ...
        @Override
        public BrowseDirection decodeType(SerializationContext context, UaDecoder decoder) {
            return decoder.readEnum(null, BrowseDirection.class);
        }

        @Override
        public void encodeType(SerializationContext context, UaEncoder encoder, BrowseDirection value) {
