...
public class DeleteMonitoredItemsResponse implements UaResponseMessage {
    ...
    public static class Codec extends BuiltinDataTypeCodec<DeleteMonitoredItemsResponse> {
        ...
        @Override
        public DeleteMonitoredItemsResponse decode(UaDecoder decoder) throws UaSerializationException {
        ...
        @Override
        public void encode(DeleteMonitoredItemsResponse value, UaEncoder encoder) throws UaSerializationException {
