...
public class DataTypeInitializer2 {
    public void initialize(NamespaceTable namespaceTable, DataTypeManager2 dataTypeManager) {
        try {
    ...
    private void registerStructCodecs(NamespaceTable namespaceTable, DataTypeManager2 dataTypeManager)
        throws Exception {
    ...
    private void registerEnumCodecs(NamespaceTable namespaceTable, DataTypeManager2 dataTypeManager)
        throws Exception {
