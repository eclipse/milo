...
@ToString
public class AttributeWriteMask extends OptionSetUInteger<AttributeWriteMask.Field> {
    ...
    public static AttributeWriteMask of(Collection<AttributeWriteMask.Field> fields) {
        long bits = 0L;
