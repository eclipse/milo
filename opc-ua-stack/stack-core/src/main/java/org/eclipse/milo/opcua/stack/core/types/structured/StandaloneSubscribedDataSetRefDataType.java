...
@SuperBuilder
@ToString
public class StandaloneSubscribedDataSetRefDataType extends SubscribedDataSetDataType implements UaStructure {
    ...
    public static final class Codec extends GenericDataTypeCodec<StandaloneSubscribedDataSetRefDataType> {
        ...
        @Override
        public StandaloneSubscribedDataSetRefDataType decode(SerializationContext context,
                                                             UaDecoder decoder) {
