...
public class HistoryReadResponse extends Structure implements UaResponseMessageType {
    ...
    private final HistoryReadResult @Nullable [] results;

    private final DiagnosticInfo @Nullable [] diagnosticInfos;

    public HistoryReadResponse(ResponseHeader responseHeader, HistoryReadResult @Nullable [] results,
    ...
    public HistoryReadResult @Nullable [] getResults() {
        return results;
    }
    ...
    public boolean equals(Object object) {
        ...
        HistoryReadResponse that = (HistoryReadResponse) object;
    ...
    public String toString() {
        var joiner = new StringJoiner(", ", HistoryReadResponse.class.getSimpleName() + "[", "]");
    ...
    public static final class Codec extends GenericDataTypeCodec<HistoryReadResponse> {
        ...
        @Override
        public HistoryReadResponse decodeType(EncodingContext context, UaDecoder decoder) {
