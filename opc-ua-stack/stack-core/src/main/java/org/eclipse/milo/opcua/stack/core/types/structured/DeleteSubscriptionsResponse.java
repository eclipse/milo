...
public class DeleteSubscriptionsResponse implements UaResponseMessage {
    ...
    public static class Codec extends BuiltinDataTypeCodec<DeleteSubscriptionsResponse> {
        ...
        @Override
        public DeleteSubscriptionsResponse decode(UaDecoder decoder) throws UaSerializationException {
        ...
        @Override
        public void encode(DeleteSubscriptionsResponse value, UaEncoder encoder) throws UaSerializationException {
