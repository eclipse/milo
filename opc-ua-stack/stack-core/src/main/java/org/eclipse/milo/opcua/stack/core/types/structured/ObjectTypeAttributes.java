...
public class ObjectTypeAttributes extends NodeAttributes {
    ...
    public static class BinaryCodec implements OpcBinaryDataTypeCodec<ObjectTypeAttributes> {
        @Override
        ...
        @Override
        public void encode(SerializationContext context, ObjectTypeAttributes value, OpcBinaryStreamWriter writer) throws UaSerializationException {
    ...
    public static class XmlCodec implements OpcXmlDataTypeCodec<ObjectTypeAttributes> {
        @Override
