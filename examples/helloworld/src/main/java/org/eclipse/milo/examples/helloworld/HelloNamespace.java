...
public class HelloNamespace implements Namespace {
    ...
    public void write(WriteContext context, List<WriteValue> writeValues) {
        context.complete(writeValues.stream().
                map(writeValue -> {
                    nodesValues.put(nodeIdToString(writeValue.getNodeId()), writeValue.getValue().getValue().getValue());
                    return GOOD;
                }).collect(toList()));
    }
